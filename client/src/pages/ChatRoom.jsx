...
const ChatRoom = () => {
  ...
  return (
    <div className="container-center flex-row justify-between">
      ...
      <div className="flex flex-col w-1/5 min-w-fit justify-center items-center">Left Panel</div>      
      ...
      <div className="border-2 h-full"></div>
      <div className="flex flex-col w-1/5 min-w-fit justify-center items-center">Right Panel</div>
